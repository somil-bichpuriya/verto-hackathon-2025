...
const LoginPartner = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/partner/dashboard'); // Redirect to partner dashboard after successful login
    } catch (err: any) {
    ...
    <div className="login-page">
      <div className="login-container">
        ...
        <div className="demo-credentials">
          ...
          <code>Email: demo@partner.com</code>
        ...
        <div className="login-footer">
          ...
          <div className="login-links">
            <Link to="/register/partner" className="login-link">Register as Partner</Link>
